...
7. `./scripts/check_config.sh task=grasp_sphere_shadow_hand env=palm_up_workspace_scaleout runtime=distributed_4gpu`로 대규모 조합 확인
8. `./scripts/prepare_x11.sh`와 `./scripts/run_isaacsim_gui.sh`로 GUI 경로 확인
